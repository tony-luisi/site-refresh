export const projects = [
  ...
  },
  {
    ...
    technologies: ['react', 'redux', 'express', 'cloudinary', 'oauth (facebook / instagram)'],
  ...
  },
  {
    ...
    description: 'An app to help people wanting to learn Maori (te reo) to connect and chat with each other. This was my personal project during web dev course and I spent a weeks worth of effort on it.',
    technologies: ['express', 'sql (knex)', 'passport', 'hunspell', 'socket', 'oath (facebook)'],
